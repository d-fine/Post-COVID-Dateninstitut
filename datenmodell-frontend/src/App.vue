<template>
  <DynamicDialog />
  <Toast />
  <div class="bg-(--df-faded-light-blue) flex flex-col min-h-screen items-center">
    <NavigationBar class="pb-4 bt-4 flex-0 w-7xl" />
    <div class="flex flex-1 flex-col w-full items-center">
      <RouterView />
    </div>
    <ContactBar class="pb-4 bt-4 flex-0 w-7xl" />
  </div>
</template>

<script lang="ts">
import NavigationBar from './components/general/NavigationBar.vue';
import ContactBar from './components/general/ContactBar.vue';
...
export default defineComponent({
  name: 'app',
  components: { DynamicDialog, NavigationBar, ContactBar, Toast },

...
client_id="$(grep client_id $credentials_file | awk -F '=' '{print $2}')"
key_path="$(grep key_path $credentials_file | awk -F '=' '{print $2}')"
...
target='["{\"id\":1,\"research_data\":\"test research data\",\"security_column\":\"'${client_id}'\"}"]'
echo
echo

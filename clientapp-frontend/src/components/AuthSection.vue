<template>
  <div>
    <Button v-if="isUserLoggedIn == false" label="Log in" name="login_button" @click="login" />
    <Button v-if="isUserLoggedIn == true" label="Logout" name="logout_button" @click="logoutViaDropdown" />
  </div>
</template>

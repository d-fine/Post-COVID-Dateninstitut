...
export default defineComponent({
  name: 'app',
  components: { DynamicDialog, ContactBar, NavigationBar, Toast },
...
<template>
  <Toast />
  <div class="df-light-blue flex flex-col min-h-screen items-center">
...
<style scoped>
.df-light-blue {
  background-color: var(--df-faded-light-blue);
}

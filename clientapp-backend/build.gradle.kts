...
tasks.register(
  ...
  input =
      project
          .file("$rootDir/clientapp-backend/eurodat-api-spec/eurodatDataManagementService.yaml")
          .path
  outputDir.set(
...
tasks.register(
  ...
  input =
      project
          .file("$rootDir/clientapp-backend/eurodat-api-spec/eurodatTransactionService.yaml")
          .path
  outputDir.set(
